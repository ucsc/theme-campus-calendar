...
$(document).ready(function () {
	...
	if (document.querySelector(".page-title a")) {
		for (var n = document.querySelector(".page-title a").innerHTML.split(" "), r = ["of", "and", "is", "&amp;"], t = 0; t < n.length; t++)
			for (var o = 0; o < r.length; o++)
				n[t].toLowerCase() == r[o] && (n[t] = '<span class="flourish">' + n[t] + "</span>");
		var d = n.join(" ");
		document.querySelector(".page-title a").innerHTML = d
	}
})